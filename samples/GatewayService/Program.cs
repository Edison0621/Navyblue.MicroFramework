...
internal sealed record ForwardCatalogUpsertRequest(string Name, decimal Price, bool IsActive);
...
internal sealed record ForwardCreateOrderRequest(string ProductId, int Quantity, string? PromoCode);
